 ...
 //   @Environment(\.managedObjectContext) var context
    ...
    var body: some View {
               ZStack {
                    ...
                    .padding(.vertical, showButtonsBar ? 5 : 0)
                    .background(
                        RoundedRectangleShape(color: .accentColor.opacity(showButtonsBar ? 0.2 : 0.0))
                    )
          }
                                            ...
                                            ForEach(sector.professions ?? [], id: \.self) {profession in
                                                Button {
                                                    ...
                                                    withAnimation {
                                                        ...
                                                        roadMapViewModel.professions = sector.professions ?? []
                                                        }
                                                } label: {
...
#Preview {
    VStack {
        ...
        HeaderView(showAddEducationTaskView: .constant(false), showAddWorkTaskView: .constant(false))
