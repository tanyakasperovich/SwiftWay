...
struct Sector: Identifiable, Hashable, Codable {
    ...
    init(id: String, title: String, professions: [Profession], color: String) {
        self.title = title
...
struct Profession: Identifiable, Hashable, Codable {
    ...
    init(title: String, sectorId: String, color: String, image: String) {
        self.title = title
    ...
    init(from decoder: Decoder) throws {
        ...
        self.id = try container.decode(String.self, forKey: .id)
        self.title = try container.decodeIfPresent(String.self, forKey: .title)
        self.sectorId = try container.decodeIfPresent(String.self, forKey: .sectorId)
        self.color = try container.decodeIfPresent(String.self, forKey: .color)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(self.id, forKey: .id)
        try container.encodeIfPresent(self.title, forKey: .title)
        try container.encodeIfPresent(self.sectorId, forKey: .sectorId)
        try container.encodeIfPresent(self.color, forKey: .color)
