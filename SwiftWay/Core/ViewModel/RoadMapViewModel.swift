...
//    @AppStorage("sectorColor") var sectorColor: String = "SectorIT"
  ...
  //  @Published var  filteredAndSortedLevel: [Level] = []
    ...
    func uploadSectors() async throws {
        let sectorIT = Sector(title: "IT", professions: [Profession(title: "IOS Developer", sectorId: "", color: "SectorIT", image: "swift"), Profession(title: "Product Designer", sectorId: "", color: "SectorIT", image: "paintbrush.pointed"), Profession(title: "UI/UX Designer", sectorId: "IT", color: "SectorIT", image: "paintbrush.pointed")], color: "SectorIT")
        let sectorBeauty = Sector(title: "Beauty", professions: [Profession(title: "Lash Maker", sectorId: "", color: "SectorBeauty", image: "eyebrow"), Profession(title: "Nails Master", sectorId: "", color: "SectorBeauty", image: "paintbrush.pointed")], color: "SectorBeauty")
        ...
        for sector in sectors {
            for profession in sector.professions ?? [] {
                if profession.id == professionId {
                    ...
                    self.professions = sector.professions ?? []
                }
            }
        }
    }
