...
@MainActor final class RoadMapViewModel: ObservableObject {
    @Published var isLoadingSectors: Bool = false
...
//    
//    @AppStorage("pickerTitle") var pickerTitle: String = "Select Profession"
//    @AppStorage("sectorColor") var sectorColor: String = "SectorIT"
    
    @Published var selectedProfessionId: String? = nil
  ...
  //  @Published var  filteredAndSortedLevel: [Level] = []
    ...
    func uploadSectors() async throws {
        let sectorIT = Sector(title: "IT", professions: [Profession(title: "IOS Developer", sectorTitle: "IT", color: "SectorIT", image: "swift"), Profession(title: "Product Designer", sectorTitle: "IT", color: "SectorIT", image: "paintbrush.pointed"), Profession(title: "UI/UX Designer", sectorTitle: "IT", color: "SectorIT", image: "paintbrush.pointed")], color: "SectorIT")
        let sectorBeauty = Sector(title: "Beauty", professions: [Profession(title: "Lash Maker", sectorTitle: "Beauty", color: "SectorBeauty", image: "eyebrow"), Profession(title: "Nails Master", sectorTitle: "Beauty", color: "SectorBeauty", image: "paintbrush.pointed")], color: "SectorBeauty")
    ...
    func setProfession(professionId: String) async throws {
        for sector in sectors {
            for profession in sector.professions ?? [] {
    ...
    func professionSelected(option: String) async throws {
        self.selectedProfessionId = option
        self.professions = []
        self.levels = []
    ...
    func getLevels() {
            Task {
                let (newLevels, lastDocument) = try await RoadMapManager.shared.getAllLevels(forProfession: selectedProfessionId, count: 10, lastDocument: lastDocument)

                self.levels.append(contentsOf: newLevels)
                if let lastDocument {
...
//    func getUserSelectedProfession(profession: Profession) async throws {
//        self.profession = try await RoadMapManager.shared.getProfession(sectorId: profession.sectorTitle ?? "", professionId: profession.id)
//    }
//    
//    func getProfessions(sectorId: String) async throws {
//       // for sector in sectors {
//            self.professions = try await RoadMapManager.shared.getProfessions(sectorId: sectorId)
//       // }
//    }
    ...
    //   Upload Levels ...
           func uploadRoadMapLevels() async throws {
               ...
               ], level: 1, professionId: "IOS Developer")
               ...
               ], level: 2, professionId: "IOS Developer")
               ...
               ], level: 3, professionId: "IOS Developer")
               ...
               ], level: 4, professionId: "IOS Developer")
               ...
               ], level: 5, professionId: "IOS Developer")
               ...
               ], level: 6, professionId: "IOS Developer")
